    ...
    Query: {
        ...
        Mutation: {
            ...
            updateProduct: async (parent, { _id, value, bidderId, bidderName, bidTimeStamp }) => {
                ...
                await Product.findOneAndUpdate({ _id: _id, bidValue: {$1t: value } }, { bidValue: value, bidTimeStamp: bidTimeStamp, bidderName: bidderName, bidderId: bidderId }, { retureOriginal: false });
